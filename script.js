...
var movieTitleText = movieTitleInput.value.trim();

var movieTitles = [];

function init() {
    var storedMovies = JSON.parse(localStorage.getItem("movie-titles"));
...
function storeMovieTitles() {
    localStorage.setItem("movie-titles", JSON.stringify(movieTitles));
};
